  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-72 border-r border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-950 lg:flex lg:flex-col">
      ...
      <div className="border-b border-slate-200 p-6 dark:border-slate-800">
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-cyan-500 to-indigo-500 shadow-lg shadow-blue-500/30">
      ...
      <div className="p-4">
        <div className="rounded-3xl bg-gradient-to-br from-blue-500 via-cyan-500 to-indigo-500 p-5 text-white">
          ...
          <p className="mt-2 text-sm text-white/80">
            ...
            and AI-powered healthcare insights.
          </p>

...
const privacySettings = [
    {
        id: "anonymousForum",
        title: "Anonymous Forum Posting",
        description: "Keep your identity hidden in forum posts.",
        icon: MessageCircle,
    },
    {
        id: "wellnessStats",
        title: "Show Wellness Statistics",
        description: "Allow wellness statistics to be displayed.",
        icon: Eye,
    },
    {
        id: "aiRecommendations",
        title: "Allow AI Recommendations",
        description: "Use your data for personalized AI guidance.",
        icon: Sparkles,
    },
];
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="mb-4 flex items-center justify-between gap-3">
                <div>
                    ...
                    <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                        Control your privacy and personalization preferences.
                    </p>
                </div>
            ...
            <div className="mt-3 rounded-xl bg-slate-50 px-3 py-2 dark:bg-slate-800/50">
                <p className="text-[10px] leading-relaxed text-slate-500 dark:text-slate-400">
                    Your privacy preferences can be changed at any time.
                </p>
            </div>
        </div>
    );
